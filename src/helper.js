...
export const api = (method, path, title) =>
...
export const apiDescription = apiDescription =>
  `* @apiDescription ${apiDescription}`
export const apiPermission = apiPermission =>
  `* @apiPermission ${apiPermission}`
export const apiHeader = (key, val) => `* @apiHeader ${key} ${val}`
// feat:adds desc
export const apiParam = (type, name, desc) =>
  `* @apiParam {${type}} ${name} ${desc}`
export const apiParamExample = (type, desc) =>
  `* @apiParamExample {${type}} ${desc}:`
export const apiSuccess = (status, type, name, desc) =>
  `* @apiSuccess (${status}) {${type}} ${name} ${desc}`
export const apiSuccessExample = (type, desc) =>
  `* @apiSuccessExample {${type}} ${desc}:`
// feat:adds apiError
export const apiError = (status, type, name, desc) =>
  `* @apiError (${status}) {${type}} ${name} ${desc}`
export const apiErrorExample = (type, desc) =>
  `* @apiErrorExample {${type}} ${desc}:`
...
export const apiDefine = (name, title, desc) =>
  `* @apiDefine ${name} ${title} ${desc}`
